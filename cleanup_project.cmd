...
title Audion Doc to PDF - Cleanup
...
echo ======================================================================
echo   AUDION DOC TO PDF - LEAN SOURCE CLEANUP
echo ======================================================================
echo Root:
echo   %BASE_DIR%
echo.
...
echo.
echo Protected: system_core source, config, docs, launchers, install scripts, licenses policies.
echo.
